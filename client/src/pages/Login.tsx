...
//     //   const url = isLoginMode ? "http://localhost:7000/api/users/signup" : "http://localhost:7000/api/users/login";
  
//     //   try {
//     //     const response = await axios.post(url, {
//     //       name: isLoginMode ? formData.name: undefined,
//     //       email: formData.email,
//     //       password: formData.password,
//     //       accountType: isLoginMode ? undefined : formData.accountType
//     //     });
...
//             <TabsTrigger value="login" onClick={() => setIsLoginMode(true)}>Login</TabsTrigger>
//             <TabsTrigger value="signup" onClick={() => setIsLoginMode(false)}>Sign Up</TabsTrigger>
//           </TabsList>
